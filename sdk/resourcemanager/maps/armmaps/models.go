...
type AccountProperties struct {
	...
	// default, Maps REST APIs process requests according to the account location or the geographic scope [https://learn.microsoft.com/en-us/azure/azure-maps/geographic-scope].
