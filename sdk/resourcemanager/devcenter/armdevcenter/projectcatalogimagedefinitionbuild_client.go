...
//   - imageDefinitionName - The name of the Image Definition.
//   - buildName - The ID of the Image Definition Build.
//   - options - ProjectCatalogImageDefinitionBuildClientGetDetailsOptions contains the optional parameters for the ProjectCatalogImageDefinitionBuildClient.GetDetails
//     method.
func (client *ProjectCatalogImageDefinitionBuildClient) GetDetails(ctx context.Context, resourceGroupName string, projectName string, catalogName string, imageDefinitionName string, buildName string, options *ProjectCatalogImageDefinitionBuildClientGetDetailsOptions) (ProjectCatalogImageDefinitionBuildClientGetDetailsResponse, error) {
	var err error
	const operationName = "ProjectCatalogImageDefinitionBuildClient.GetDetails"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getDetailsCreateRequest(ctx, resourceGroupName, projectName, catalogName, imageDefinitionName, buildName, options)
	if err != nil {
		return ProjectCatalogImageDefinitionBuildClientGetDetailsResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return ProjectCatalogImageDefinitionBuildClientGetDetailsResponse{}, err
...
func (client *ProjectCatalogImageDefinitionBuildClient) getDetailsCreateRequest(ctx context.Context, resourceGroupName string, projectName string, catalogName string, imageDefinitionName string, buildName string, options *ProjectCatalogImageDefinitionBuildClientGetDetailsOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevCenter/projects/{projectName}/catalogs/{catalogName}/imageDefinitions/{imageDefinitionName}/builds/{buildName}/getDetails"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
func (client *ProjectCatalogImageDefinitionBuildClient) getDetailsHandleResponse(resp *http.Response) (ProjectCatalogImageDefinitionBuildClientGetDetailsResponse, error) {
	result := ProjectCatalogImageDefinitionBuildClientGetDetailsResponse{}
