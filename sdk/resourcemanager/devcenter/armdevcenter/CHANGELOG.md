...
- New enum type `ListImageBuildTaskGroupsIncludeParameter` with values `ListImageBuildTaskGroupsIncludeParameterTaskGroups`
...
- New function `*ProjectCatalogImageDefinitionBuildClient.GetDetails(context.Context, string, string, string, string, string, *ProjectCatalogImageDefinitionBuildClientGetDetailsOptions) (ProjectCatalogImageDefinitionBuildClientGetDetailsResponse, error)`
