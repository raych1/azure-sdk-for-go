...
// type Microsoft Customer Agreement, Microsoft Partner Agreement and Enterprise Agreement. If you are
// a MCA Individual (Pay-as-you-go) customer, then please use the Azure portal experience to create the billing profile.
...
// Microsoft Customer Agreement, Microsoft Partner Agreement and Enterprise Agreement. If you are
// a MCA Individual (Pay-as-you-go) customer, then please use the Azure portal experience to create the billing profile.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-04-01
