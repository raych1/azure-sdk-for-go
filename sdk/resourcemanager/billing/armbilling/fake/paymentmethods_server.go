...
type PaymentMethodsServer struct {
	// BeginDeleteAtBillingProfile is the fake for method PaymentMethodsClient.BeginDeleteAtBillingProfile
	// HTTP status codes to indicate success: http.StatusAccepted, http.StatusNoContent
	BeginDeleteAtBillingProfile func(ctx context.Context, billingAccountName string, billingProfileName string, paymentMethodName string, options *armbilling.PaymentMethodsClientBeginDeleteAtBillingProfileOptions) (resp azfake.PollerResponder[armbilling.PaymentMethodsClientDeleteAtBillingProfileResponse], errResp azfake.ErrorResponder)
...
func NewPaymentMethodsServerTransport(srv *PaymentMethodsServer) *PaymentMethodsServerTransport {
	return &PaymentMethodsServerTransport{
		srv:                          srv,
		beginDeleteAtBillingProfile:  newTracker[azfake.PollerResponder[armbilling.PaymentMethodsClientDeleteAtBillingProfileResponse]](),
...
type PaymentMethodsServerTransport struct {
	...
	beginDeleteAtBillingProfile  *tracker[azfake.PollerResponder[armbilling.PaymentMethodsClientDeleteAtBillingProfileResponse]]
...
func (p *PaymentMethodsServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	switch method {
	case "PaymentMethodsClient.BeginDeleteAtBillingProfile":
		resp, err = p.dispatchBeginDeleteAtBillingProfile(req)
...
func (p *PaymentMethodsServerTransport) dispatchBeginDeleteAtBillingProfile(req *http.Request) (*http.Response, error) {
	if p.srv.BeginDeleteAtBillingProfile == nil {
		return nil, &nonRetriableError{errors.New("fake for method BeginDeleteAtBillingProfile not implemented")}
	}
	beginDeleteAtBillingProfile := p.beginDeleteAtBillingProfile.get(req)
	if beginDeleteAtBillingProfile == nil {
		...
		respr, errRespr := p.srv.BeginDeleteAtBillingProfile(req.Context(), billingAccountNameParam, billingProfileNameParam, paymentMethodNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDeleteAtBillingProfile = &respr
		p.beginDeleteAtBillingProfile.add(req, beginDeleteAtBillingProfile)
	}

	resp, err := server.PollerResponderNext(beginDeleteAtBillingProfile, req)
	if err != nil {
		return nil, err
	}

	if !contains([]int{http.StatusAccepted, http.StatusNoContent}, resp.StatusCode) {
		p.beginDeleteAtBillingProfile.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusAccepted, http.StatusNoContent", resp.StatusCode)}
	}
	if !server.PollerResponderMore(beginDeleteAtBillingProfile) {
		p.beginDeleteAtBillingProfile.remove(req)
	}
