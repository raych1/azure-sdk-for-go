...
// AccountPatchProperties - The properties of a(n) BillingAccount
...
type AccountPolicy struct {
	// The properties of a(n) BillingAccountPolicy
...
// AccountPolicyProperties - The properties of a(n) BillingAccountPolicy
...
// AccountPolicyPropertiesAutoGenerated - A policy at billing account scope.
type AccountPolicyPropertiesAutoGenerated struct {
	// The policies for Enterprise Agreement enrollments.
	EnterpriseAgreementPolicies *AccountPolicyPropertiesEnterpriseAgreementPolicies
...
// AccountProperties - The properties of a(n) BillingAccount
...
// AccountPropertiesAutoGenerated - A billing account.
type AccountPropertiesAutoGenerated struct {
	// The billing account name.
	DisplayName *string
...
type Agreement struct {
	// The properties of a(n) Agreement
...
// AgreementProperties - The properties of a(n) Agreement
...
// AgreementPropertiesAutoGenerated - An agreement.
type AgreementPropertiesAutoGenerated struct {
	// READ-ONLY; The mode of acceptance for an agreement.
	AcceptanceMode *AcceptanceMode
...
// AssociatedTenantProperties - The properties of a(n) AssociatedTenant
...
// AssociatedTenantPropertiesAutoGenerated - An associated tenant.
type AssociatedTenantPropertiesAutoGenerated struct {
	// The state determines whether users from the associated tenant can be assigned roles for commerce activities like viewing
	// and downloading invoices, managing payments, and making purchases.
	BillingManagementState *BillingManagementTenantState
...
type AvailableBalance struct {
	// The properties of a(n) AvailableBalance
...
// AvailableBalanceProperties - The properties of a(n) AvailableBalance
...
// AvailableBalancePropertiesAutoGenerated - The Available Credit or Payment on Account Balance. The credit balance can be
// used to settle due or past due invoices.
type AvailableBalancePropertiesAutoGenerated struct {
	// Credit amount for immediate payment.
	Amount *AvailableBalancePropertiesAmount
...
type CustomerPolicy struct {
	// The properties of a(n) CustomerPolicy
...
// CustomerPolicyProperties - The properties of a(n) CustomerPolicy
...
// CustomerPolicyPropertiesAutoGenerated - A policy at customer scope.
type CustomerPolicyPropertiesAutoGenerated struct {
	// REQUIRED; The policy that controls whether the users in customer's organization can view charges at pay-as-you-go prices.
	ViewCharges *ViewChargesPolicy
...
// CustomerProperties - The properties of a(n) Customer
...
// CustomerPropertiesAutoGenerated - A partner's customer.
type CustomerPropertiesAutoGenerated struct {
	// Azure plans enabled for the customer.
	EnabledAzurePlans []*AzurePlan
...
// DepartmentProperties - The properties of a(n) Department
...
// DepartmentPropertiesAutoGenerated - Optional grouping of enrollment accounts to segment costs into logical groupings and
// set budgets.
type DepartmentPropertiesAutoGenerated struct {
	// The cost center associated with the department.
	CostCenter *string
...
// EnrollmentAccountProperties - The properties of a(n) EnrollmentAccount
...
// EnrollmentAccountPropertiesAutoGenerated - It is an organizational hierarchy within a billing account to administer and
// manage azure costs.
type EnrollmentAccountPropertiesAutoGenerated struct {
	// The cost center associated with the enrollment account.
	CostCenter *string
...
// InvoiceProperties - The properties of a(n) Invoice
...
// InvoicePropertiesAutoGenerated - An invoice.
type InvoicePropertiesAutoGenerated struct {
	// The amount due as of now.
	AmountDue *InvoicePropertiesAmountDue
...
// InvoiceSectionProperties - The properties of a(n) InvoiceSection
...
// InvoiceSectionPropertiesAutoGenerated - An invoice section.
type InvoiceSectionPropertiesAutoGenerated struct {
	// The name of the invoice section.
	DisplayName *string
...
type ProductPatch struct {
	// The properties of a(n) Product
	Properties *ProductPatchProperties
...
// ProductPatchProperties - The properties of a(n) Product
type ProductPatchProperties struct {
...
// ProductProperties - The properties of a(n) Product
...
// ProductPropertiesAutoGenerated - A product.
type ProductPropertiesAutoGenerated struct {
	// Indicates whether auto renewal is turned on or off for a product.
	AutoRenew *AutoRenew
...
type ProfilePolicy struct {
	// The properties of a(n) BillingProfilePolicy
...
// ProfilePolicyProperties - The properties of a(n) BillingProfilePolicy
...
// ProfilePolicyPropertiesAutoGenerated - A policy at billing profile scope.
type ProfilePolicyPropertiesAutoGenerated struct {
	// The policies for Enterprise Agreement enrollments.
	EnterpriseAgreementPolicies *ProfilePolicyPropertiesEnterpriseAgreementPolicies
...
// ProfileProperties - The properties of a(n) BillingProfile
...
// ProfilePropertiesAutoGenerated - A billing profile.
type ProfilePropertiesAutoGenerated struct {
	// Billing address.
	BillTo *ProfilePropertiesBillTo
...
// PropertyProperties - The properties of a(n) BillingProperty
...
// PropertyPropertiesAutoGenerated - A billing property.
type PropertyPropertiesAutoGenerated struct {
	// The cost center applied to the subscription. Available for agreement type Microsoft Customer Agreement and Microsoft Partner
	// Agreement. This property can be updated via patch.
	CostCenter *string
...
// RequestProperties - The properties of a(n) BillingRequest
...
// RequestPropertiesAutoGenerated - A request submitted by a user to manage billing. Users with an owner role on the scope
// can approve or decline these requests.
type RequestPropertiesAutoGenerated struct {
	// Additional information for the billing request.
	AdditionalInformation map[string]*string
...
// RoleAssignmentProperties - The properties of a(n) BillingRoleAssignment
...
// RoleAssignmentPropertiesAutoGenerated - The properties of the billing role assignment.
type RoleAssignmentPropertiesAutoGenerated struct {
	// REQUIRED; The ID of the role definition.
	RoleDefinitionID *string
...
// RoleDefinitionProperties - The properties of a(n) BillingRoleDefinition
...
// RoleDefinitionPropertiesAutoGenerated - The properties of a role definition.
type RoleDefinitionPropertiesAutoGenerated struct {
	// REQUIRED; The name of the role.
	RoleName *string
...
type SubscriptionPolicy struct {
	// The properties of a(n) SubscriptionPolicy
...
// SubscriptionPolicyProperties - The properties of a(n) SubscriptionPolicy
...
// SubscriptionPolicyPropertiesAutoGenerated - A policy at subscription scope.
type SubscriptionPolicyPropertiesAutoGenerated struct {
	// List of all policies defined at the billing scope.
	Policies []*PolicySummary
...
// TransactionProperties - The properties of a(n) Transaction
...
// TransactionPropertiesAutoGenerated - A transaction.
type TransactionPropertiesAutoGenerated struct {
	// The amount of any Azure credits automatically applied to this transaction.
	AzureCreditApplied *TransactionPropertiesAzureCreditApplied
