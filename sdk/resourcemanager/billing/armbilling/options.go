...
// PaymentMethodsClientBeginDeleteAtBillingProfileOptions contains the optional parameters for the PaymentMethodsClient.BeginDeleteAtBillingProfile
// method.
type PaymentMethodsClientBeginDeleteAtBillingProfileOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
