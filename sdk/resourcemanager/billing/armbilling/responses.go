...
// PaymentMethodsClientDeleteAtBillingProfileResponse contains the response from method PaymentMethodsClient.BeginDeleteAtBillingProfile.
type PaymentMethodsClientDeleteAtBillingProfileResponse struct {
	// placeholder for future response values
}
