...
// BeginDownloadByBillingSubscription - Gets a URL to download an invoice by billing subscription.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-04-01
//   - invoiceName - The ID that uniquely identifies an invoice.
...
// DownloadByBillingSubscription - Gets a URL to download an invoice by billing subscription.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-04-01
...
// Get - Gets an invoice by ID. The operation is supported for all billing account types.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-04-01
//   - invoiceName - The ID that uniquely identifies an invoice.
...
// GetByBillingAccount - Gets an invoice by billing account name and ID. The operation is supported for billing accounts with
...
// GetByBillingSubscription - Gets an invoice by subscription ID and invoice ID.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-04-01
//   - invoiceName - The ID that uniquely identifies an invoice.
...
// is supported for billing accounts with agreement type Microsoft Partner Agreement, Microsoft Customer
// Agreement, or Microsoft Online Services Program.
//
// Generated from API version 2024-04-01
//   - billingAccountName - The ID that uniquely identifies a billing account.
