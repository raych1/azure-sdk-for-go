...
func (c ConfigurationSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "feature", c.Feature)
...
func (c *ConfigurationSettings) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "feature":
			err = unpopulate(val, "Feature", &c.Feature)
			delete(rawMsg, key)
...
func (c ConnectedClusterProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "azureHybridBenefit", c.AzureHybridBenefit)
	populate(objectMap, "configurationSettings", c.ConfigurationSettings)
...
func (c *ConnectedClusterProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "configurationSettings":
			err = unpopulate(val, "ConfigurationSettings", &c.ConfigurationSettings)
			delete(rawMsg, key)
