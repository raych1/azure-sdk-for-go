...
// ReplicasClientListByMongoClusterResponse contains the response from method ReplicasClient.NewListByMongoClusterPager.
type ReplicasClientListByMongoClusterResponse struct {
