...
const (
	// NetworkAPIVersionTwoThousandTwenty1101 - Initial version supported. Later versions are supported as well.
...
const (
	// StatusLevelTypesError - Error Level
	StatusLevelTypesError StatusLevelTypes = "Error"
	// StatusLevelTypesInfo - Info level
	StatusLevelTypesInfo StatusLevelTypes = "Info"
	// StatusLevelTypesWarning - Warning level
